		...
		<div class="myvideoroom-feature-outer-table">
			...
			<div class="myvideoroom-feature-table-large">
				...
				<div id="childmodule<?php echo esc_attr( $index++ ); ?>">
					<p><?php esc_html_e( 'You can enable and disable the custom conference center rooms without affecting other room types safely. Users will receive an access denied page on accessing a room with a disabled module.', 'myvideoroom' ); ?>
					</p>
				</div>
			</div>
		</div>
