...
return function (
	...
	<table class="myvideoroom-room-builder-output" data-copied-text="<?php echo esc_attr__( 'Copied!', 'myvideoroom' ); ?>">
		<thead>
			<tr>
				<th style="width:50%">
		...
		<tbody>
			...
			<tr>
				<?php if ( $text_shortcode_host->is_host() ) { ?>
					<td>
						<code class="myvideoroom-shortcode-example"><?php echo esc_html( $text_shortcode_host->output_shortcode_text() ); ?></code>
						<br />
						<input class="copy-to-clipboard button-secondary" type="button" value="<?php esc_attr_e( 'Copy to clipboard', 'myvideoroom' ); ?>" />
					</td>

					<td>
						<code class="myvideoroom-shortcode-example"><?php echo esc_html( $text_shortcode_guest->output_shortcode_text() ); ?></code>
						<br />
						<input class="copy-to-clipboard button-secondary" type="button" value="<?php esc_attr_e( 'Copy to clipboard', 'myvideoroom' ); ?>" />
					</td>
				<?php } else { ?>
