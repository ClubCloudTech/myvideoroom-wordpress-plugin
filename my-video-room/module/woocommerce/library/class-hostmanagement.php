...
class HostManagement {
	...
	public function master_button( $room_name, bool $button_only = null ): ?string {
		...
		if ( $sync_is_on && $master_status ) {
			...
			return $pre_text . ' 
			<button ' . $title_box . '  class="mvr-form-button mvr-main-button-cancel myvideoroom-woocommerce-basket-ajax myvideoroom-button-override" data-target="' . $target . '">
			<a  data-target="' . $target . '" data-input-type="' . $button_type . '" data-auth-nonce="' . $nonce . '" data-room-name="' . $room_name . '"data-record-id="' . $id_text . '" class="myvideoroom-woocommerce-basket-ajax myvideoroom-button-override myvideoroom-button-link">' . $button_label . '</a> </button>';
		}

		if ( $master_status ) {
			if ( ! $button_only ) {
				$pre_text = '<p class ="mvr-notification-align myvideoroom-text-heading-override"><strong>' . \esc_html__( 'Room Basket Owner ', 'myvideoroom' ) . '</strong></p>';
			}
	...
	public function sync_notification_button( $room_name, bool $button_only = null ): ?string {
		...
		switch ( $sync_status ) {
			case WooCommerce::SETTING_REQUEST_MASTER_PENDING:
				...
				return '
				<strong>' . \esc_html__( 'Basket Ownership Pending ', 'myvideoroom' ) . '</strong><button  ' . $title_box . '  class="mvr-form-button mvr-main-button-cancel myvideoroom-woocommerce-basket-ajax myvideoroom-button-override">
					<a  data-target="' . $target . '" data-input-type="' . $withdraw_button_type . '" data-auth-nonce="' . $withdraw_nonce . '" data-room-name="' . $room_name . '"data-record-id="' . $id_text . '" class="myvideoroom-woocommerce-basket-ajax myvideoroom-button-link myvideoroom-button-override">' . $withdraw_button_label . '</a>
					</button>';
			...
			case WooCommerce::SETTING_REQUEST_MASTER:
				...
				return '<strong>' . \esc_html__( 'Basket Owner Change Request', 'myvideoroom' ) . '</strong>- <button ' . $title_box . '  class="mvr-form-button mvr-main-button-enabled myvideoroom-woocommerce-basket-ajax myvideoroom-button-override" data-target = "mvr-shopping-basket">
					<a  data-target="' . $target . '" data-input-type="' . $accept_button_type . '" data-auth-nonce="' . $accept_nonce . '" data-room-name="' . $room_name . '"data-record-id="' . $id_text . '" class="myvideoroom-woocommerce-basket-ajax myvideoroom-button-link myvideoroom-button-override">' . $accept_button_label . '</a>
					</button>
					<button  ' . $title_box . '  class="mvr-form-button mvr-main-button-cancel myvideoroom-woocommerce-basket-ajax myvideoroom-button-override" data-target = "mvr-shopping-basket">
					<a  data-target="' . $target . '" data-input-type="' . $decline_button_type . '" data-auth-nonce="' . $decline_nonce . '" data-room-name="' . $room_name . '"data-record-id="' . $id_text . '" class="myvideoroom-woocommerce-basket-ajax myvideoroom-button-link myvideoroom-button-override">' . $decline_button_label . '</a>
					</button>';
		}
		// Client Section.
		if ( $am_i_downloading ) {
			...
			return '
			<button ' . $title_box . '  class="mvr-form-button mvr-main-button-stop mvr-main-button-cancel myvideoroom-woocommerce-basket-ajax myvideoroom-button-override" 
				<a  data-target="' . $target . '" data-input-type="' . $withdraw_button_type . '" data-auth-nonce="' . $withdraw_nonce . '" data-room-name="' . $room_name . '"data-record-id="' . $id_text . '" class="myvideoroom-woocommerce-basket-ajax myvideoroom-button-link myvideoroom-button-override">' . $withdraw_button_label . '</a>
				</button>';
		}
		...
		if ( $sync_is_available && ! $am_i_master && ! $am_i_downloading ) {
			...
			return $pre_text . '
			<button ' . $title_box . '  class="mvr-main-button-enabled myvideoroom-button-separation myvideoroom-woocommerce-basket-ajax myvideoroom-button-override">
				<a  data-target="' . $target . '" data-input-type="' . $withdraw_button_type . '" data-auth-nonce="' . $withdraw_nonce . '" data-room-name="' . $room_name . '"data-record-id="' . $id_text . '" class="myvideoroom-woocommerce-basket-ajax myvideoroom-button-link myvideoroom-button-override">' . $withdraw_button_label . '</a>
				</button>';
		}
		return '';
