	...
	<form method="post" action="">
		...
		<h2 class="mvr-title-header"><?php esc_html_e( 'Override User preferences', 'my-video-room' ); ?></h1>
			...
			<label for="myvideoroom_security_anonymous_enabled_preference_<?php echo esc_attr( $id_index ); ?>">
				<h2 class="mvr-title-header"><i
						class="dashicons mvr-icons dashicons-admin-users"></i><?php esc_html_e( 'Restrict Anonymous Access (Force Users to Register)', 'my-video-room' ); ?>
				</h2>
			</label>
			<input
				type="checkbox"
			...
			<label
				...
				<h2 class="mvr-title-header"><i
						class="dashicons mvr-icons dashicons-id"></i><?php esc_html_e( 'Enable Role Control - For Allowed Roles', 'my-video-room' ); ?>
				</h2>
			</label>
			<input
				type="checkbox"
