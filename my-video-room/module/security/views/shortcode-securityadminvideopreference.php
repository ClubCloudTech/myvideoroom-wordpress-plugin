...
<div id="security-video-host-wrap" class="mvr-nav-settingstabs-outer-wrap">
			...
			?>
				...
				<input name="myvideoroom_extras_security_user_id" type="hidden" value="
					...
					<hr>
					<h1 class="mvr-title-header"><?php echo esc_html__( 'Settings', 'my-video-room' ); ?></h1><br><br>
					<h2 class="mvr-title-header"><i class="dashicons mvr-icons dashicons-dismiss"></i><?php echo esc_html__( 'Disable All Rooms in Site', 'my-video-room' ); ?></h2>
				</label>
				<input
					type="checkbox"
				...
				<input
					...
					<br>
					<br>
				<p><?php echo esc_html__( 'Use this setting to determine what user roles you want to explicitly allow or - the reverse (block all users but a specific role) if you tick the Block Role option.', 'my-video-room' ); ?></p>
				<hr>
				<?php
