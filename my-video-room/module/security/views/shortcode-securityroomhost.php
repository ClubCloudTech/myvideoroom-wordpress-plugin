	...
	<form method="post" action="">
		...
		<label for="myvideoroom_security_allow_role_control_enabled_preference_<?php echo esc_attr( $id_index ); ?>">
			<h2 class="mvr-title-header"><i
					class="dashicons mvr-icons dashicons-id"></i><?php esc_html_e( 'Enable custom hosts for this room', 'my-video-room' ); ?>
			</h2>
		</label>
		<input
			type="checkbox"
		...
		<label for="myvideoroom_security_anonymous_enabled_preference_<?php echo esc_attr( $id_index ); ?>">
			<h2 class="mvr-title-header"><i
					class="dashicons mvr-icons dashicons-admin-users"></i><?php esc_html_e( 'Allow Anonymous Users to Host Rooms (not recommended)', 'my-video-room' ); ?>
			</h2>
		</label>
		<input
			type="checkbox"
