		...
		<div id="video-host-wrap" class="mvr-nav-settingstabs-outer-wrap">
				<div class="myvideoroom-feature-outer-table">
					...
					<div class="myvideoroom-feature-table-large">
						...
						<p><?php esc_html_e( 'Dependency Check - There are No Dependencies for this Module', 'myvideoroom' ); ?></p>
						</div>
					</div>
				</div>
<!-- Screenshot Marker -->
				...
				<div class="myvideoroom-feature-outer-table">
					...
					<div class="myvideoroom-feature-table-large">
						...
						if ( Factory::get_instance( BuddyPress::class )->is_buddypress_available() ) {
							?>
						<p><strong><?php esc_html_e( 'Note', 'myvideoroom' ); ?></strong><?php esc_html_e( '- This setting is shared with BuddyPress personal profile room integration as they are the same room.', 'myvideoroom' ); ?> </p>
							<?php
						}
