		...
		<table style="width:100%">
			<tr>
				<th class="myvideoroom-header-table">
					<h1 class="myvideoroom-heading-head-top"><?php echo esc_html__( 'Room Template Library', 'myvideoroom' ); ?></h1>
				</th>
			</tr>
		</table>

		<ul class ="myvideoroom-menu-ul">
			<li>
				<a class="myvideoroom-sub-menu-header-block" href="javascript:activateTab2( 'page3' )">
					<?php echo esc_html__( 'Using Templates', 'myvideoroom' ); ?>
				</a>
			</li>

			<li>
				<a class="myvideoroom-sub-menu-header-block" href="javascript:activateTab2( 'page1' )">
					<?php echo esc_html__( 'Video Room Templates', 'myvideoroom' ); ?>
				</a>
			</li>

			<li>
				<a class="myvideoroom-sub-menu-header-block" href="javascript:activateTab2( 'page2' )">
					<?php echo esc_html__( 'Reception Templates', 'myvideoroom' ); ?>
				</a>
			</li>
		</ul>

		<div id="tabCtrl2">
			<div id="page1" class="myvideoroom-sub-menu-header">
			...
			<div id="page2" class="myvideoroom-sub-menu-header">
			...
			<div id="page3" class="myvideoroom-sub-menu-header-block">
