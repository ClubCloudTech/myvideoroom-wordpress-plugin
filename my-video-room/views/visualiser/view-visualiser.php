...
<table style="width:100%">
	<form method="post" action="">
		...
		<tr>
			...
			<td class="mvr-td-head-top">
				<label for="myvideoroom_visualiser_room_name"><?php echo esc_html__( 'Room Name', 'myvideoroom' ); ?></label>
				<input type="text" id="myvideoroom_visualiser_room_name" name="myvideoroom_visualiser_room_name"
					style="    width: 65%;    background: #e3e7e8; " value="<?php echo esc_html( $room_name ); ?>">
			</td>
			<td class="mvr-td-head-top">
				...
				<input type="checkbox" class="mvr-option-box" name="myvideoroom_visualiser_show_floorplan_preference"
			...
			<td class="mvr-td-head-top">
				...
				<input type="checkbox" class="mvr-option-box" name="myvideoroom_visualiser_reception_enabled_preference"
				...
				<br>
				<input type="checkbox" class="mvr-option-box"
				...
				<label
					for="myvideoroom_visualiser_reception_video_enabled_preference_<?php echo esc_attr( $id_index ); ?>">
				...
				<input type="text" id="myvideoroom_visualiser_reception_waiting_video_url"
