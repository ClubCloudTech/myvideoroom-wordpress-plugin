...
return function (): string {
	...
	<div class="myvideoroom-outer-box-wrap">
		<table style="width:100%">
			<tr>
				<th class="myvideoroom-header-table">
					<h1 class="myvideoroom-heading-head-top"><?php echo esc_html__( 'Help / Getting Started ', 'myvideoroom' ); ?></h1>
				</th>
		...
		<ul class ="myvideoroom-menu-ul">
			<li>
				<a class="myvideoroom-sub-menu-header-block" href="javascript:activateTab2( 'page0' )">
					<?php echo esc_html__( 'Welcome to MyVideoRoom', 'myvideoroom' ); ?>
				</a>
			</li>
		</ul>

		<div id="tabCtrl2">
			<div id="page0" class="myvideoroom-tab-align">
				...
				<table style="width:100%">
					<tr>
						<th class="myvideoroom-header-table-3">
							<h1 class="myvideoroom-heading-head-top"><?php echo esc_html__( 'Activate', 'myvideoroom' ); ?></h1>
							<img src="<?php echo esc_url( plugins_url( '../img/11.png', realpath( __DIR__ . '/' ) ) ); ?>"
								alt="Design Your Room" width="90" height="90" />
						</th>
						<th class="myvideoroom-header-table-3">
							<h1 class="myvideoroom-heading-head-top"><?php echo esc_html__( 'Design Your Room', 'myvideoroom' ); ?></h1>
							<img src="<?php echo esc_url( plugins_url( '../img/21.png', realpath( __DIR__ . '/' ) ) ); ?>"
								alt="Design Your Room" width="90" height="90" />
						</th>
						<th class="myvideoroom-header-table-3">
							<h1 class="myvideoroom-heading-head-top"><?php echo esc_html__( 'Set Security', 'myvideoroom' ); ?></h1>
							<img src="<?php echo esc_url( plugins_url( '../img/31.png', realpath( __DIR__ . '/' ) ) ); ?>"
								alt="Set Security" width="90" height="90" />
						</th>
					</tr>
					<tr class="myvideoroom-td-head-top">
						<td>
						<?php
