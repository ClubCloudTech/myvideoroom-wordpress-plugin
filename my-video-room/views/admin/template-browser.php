	...
	?>
		...
		<article id="myvideoroom-how-to-use-templates">
			...
			<p>
				<?php
				esc_html_e(
					'Templates are the visual representation of your room. They allow your guests to understand the
					 type of meeting they are in. You can see a good representation of available templates for both 
					 reception, and video rooms, and reception templates tab. We are adding more templates all the time,
					  and coming soon you will be able to make your own designs.'
				);
				?>
			</p>
			...
			<p>
				<?php
				esc_html_e(
					'You can also disable the layout for your guests. This will mean MyVideoRoom will render a 
					meeting much like other packages, with a reception being turned on for your guest to wait in, whilst 
					you arrive. You can select your reception template,	and even put on a video stream for them whilst 
					they wait. '
				);
				?>
			</p>
		...
		<article id="myvideoroom-layouts">
			...
			esc_html_e(
				...
				breakout areas, layouts and scenarios. The basis of a video meeting is to select a room template for 
				your meeting, and use it to drag in guests from receptions you can also remove anyone from the meeting 
				at any time by clicking on their × symbol next to their picture.'
			);
			?>
			</p>
			...
			<?php
			esc_html_e(
				'We\'re currently working on functionality to enable you to upload your own room layouts and 
                    reception designs. We\'ll let you know when this feature is ready'
			);
			?>
			</p>
		...
		<article id="myvideoroom-receptions">
			...
			<?php
			esc_html_e(
				'Reception templates are used to show your guest a waiting area before they are allowed to join a 
				room. MyVideoRoom allows you to customise the layout, and also the video option of what you would like 
				your guest to see whilst you wait. Below are currently, available reception templates. Not all templates 
				can display video. Whilst your guest is waiting, they will be in the reception area. To begin the 
				meeting you can drag their icon into a seating position in your room layout and your meeting will 
				begin.'
			);
			?>
			</p>
