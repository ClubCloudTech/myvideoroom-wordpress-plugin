...
return function (
	...
	<form method="post" action="">
		...
		<input
			...
			class="mvr-roles-multiselect mvr-select-box"
			value="<?php /* phpcs:ignore -- is escaped properly.*/
			echo trim( esc_url_raw( Factory::get_instance( UserVideoPreferenceDAO::class )->read_user_settings( $user_id, $room_name, 'reception_video_url' ) ) ); ?>">
